...
-- Tabla puente: receta de cada platillo (relación M:N)
...
-- Meseros que atienden a los clientes
CREATE TABLE mesero (
    mesero_id SERIAL PRIMARY KEY,
    nombre VARCHAR(100) NOT NULL
);

-- Tabla que guarada un "log" porque el sistema debe registrar una alerta en una tabla de notificaciones.
